...
const MovieCard = ({ movie, addToFavorites, isFavorite }) => {
  ...
  return (
    <div className="bg-gray-500 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 flex flex-col ">
      ...
      <div className="p-4 flex flex-col  justify-between">
        ...
        <div className="text-sm text-gray-400 line-clamp-2">
          <Link to={`/movie/${movie.id}`} className="flex-1 text-center  text-white font-medium py-2 rounded-full transition duration-300">
            View Details
          </Link>
          <button 
